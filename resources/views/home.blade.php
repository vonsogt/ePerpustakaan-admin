...
<head>
  ...
  <title>ePerpustakaan - Index</title>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.html">ePerpustakaan</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="get-started"><a href="{{ url('admin') }}">Memulai</a></li>
        </ul>
      </nav><!-- .nav-menu -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>ePerpustakaan</h1>
            <h2>ePerpustakaan merupakan aplikasi perpustakaan yang dapat mengakses ePerpustakaan-admin menggunakan smartphone dimana saja dan kapan saja dengan menggunakan SATU DATABASE yang sama.</h2>
